    ...
    <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
      <div className="grid gap-16 row-gap-10 mb-8 lg:grid-cols-6">
        ...
        <div className="grid grid-cols-2 gap-5 row-gap-8 lg:col-span-4 md:grid-cols-4">
          <div className=" pt-16 lg:pt-16 md:pt-2">
            <p className="font-semibold text-base tracking-wide text-gray-800">
              About Roomio
            </p>
          ...
          <div className=" pt-16 lg:pt-16 md:pt-2">
            <p className="font-semibold tracking-wide text-gray-800 text-base ">
              Products
            </p>
            <ul className="mt-2 space-y-2">
              <li>
          ...
          <div className=" pt-16 lg:pt-16 md:pt-2">
            <p className="font-semibold tracking-wide text-gray-800 text-base ">Others</p>
            <ul className="mt-2 space-y-2">
              <li>
                <a
                  href="/"
      ...
      <div className="flex flex-col justify-between pt-5 pb-10 border-t sm:flex-row">
        <p className="text-sm text-gray-600">
          © Copyright 2024 Roomio. All rights reserved.
        </p>
        <div className="flex items-center max-md:justify-center gap-5">
          ...
          >
            ...
            >
              ...
              />
              <path
                className="fill-white transition-all divide-gray-500 group-hover:fill-indigo-800 group-focus-within:fill-indigo-800"
