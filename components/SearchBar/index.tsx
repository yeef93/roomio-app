...
function SearchBar() {
  ...
  const SearchBarContent = () => (
    <>
      ...
      <div className={`flex-1 p-4 ${!isMobile && 'border-l border-gray-200'}`}>
      ...
      <Popover className="flex-1 relative">
        <Popover.Button className={`w-full text-left p-4 ${!isMobile && 'border-l border-gray-200'}`}>
          <div className="flex items-center">
      ...
      <div className="p-4">
        <button
          ...
          className="bg-indigo-500 text-white px-4 py-2 rounded-full hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-opacity-50 flex items-center"
        >
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className={`bg-white ${isMobile ? 'rounded-lg shadow-lg' : 'rounded-full shadow-lg'} ${isMobile ? 'flex flex-col' : 'flex items-center'}`}>
        <SearchBarContent />
      </div>
    </div>
  );
